      ...
      <div>
        <S4HanaS4card
          :data="{
            ...
            description: ` Financial planning sap is designed to simplify the process of financial management and to bring all transactions in an organization in a unified system. the setup brings transparency and allows the financial head to understand the strengths, reduce expenses when possible and make an infor med decision. the versatile and flexible module can be used by organizations of every type, helping them consolidate their date.`,
          }"
        >
          ...
          <div class="relative w-full aspect-square max-w-md mx-auto">
            <div class="absolute inset-0">
              <img
                ...
                class="absolute top-4 left-4 w-full h-full object-cover shadow-lg transform -rotate-3 z-10"
              />
              <img
                :src="fi"
                alt="Financial image 1"
                class="absolute top-0 left-0 w-full h-full object-cover shadow-lg transform rotate-3 z-20"
              />
            </div>
          </div>
        </S4HanaS4card>
  ...
  <section class="py-16 bg-secondary">
    <div class="wrapper">
      ...
      <div class="flex gap-10 my-10">
        ...
        >
          <div class="relative pt-10 h-0 md:pb-[85%] lg:pb-[80%] xl:pb-[70%]">
            <img
              :src="fi_1"
              alt="Financial image 2 "
            ...
            <img
              :src="fi"
              alt="Financial image 1"
              class="absolute right-0 translate-y-1/2 w-[350px]"
            />
          </div>
        </S4HanaS4card>
        <S4HanaS4card
        ...
        >
          <div class="relative pt-10 h-0 pb-[70%]">
            <img
              :src="hcm_1"
              alt="Financial image 2"
              class="absolute w-[350px]"
      ...
      <!-- second card section -->
      <div class="flex gap-10 my-10 flex-grow">
        <S4HanaS4card
          :data="{
      ...
      <div class="my-10">
        <div class="bg-white rounded-lg shadow-md p-4 flex gap-10">
          <div class="w-6/12">
            <h3 class="text-lg font-semibold mt-4">
              Financial Supply Chain Management
            </h3>
            <p class="text-gray-600 mt-2">
              Another important module in the list, SAP financial supply chain
              management deals with credit management and to easily manage an
              enterprise’s financial requirements with enough headroom. The
              module is used to manage cash, liquidity state, treasure and also
              foresee risks involved in an investment. Further, into the
              lifecycle of the financial supply chain, it can also be used to
              manage disputes, payments and acts as a platform to monitor
              collections for the products supplied during a specific time
              period.
            </p>
          </div>

          <div class="w-6/12">
            <div class="relative h-0 pb-[60%]">
              <img
                :src="fscm_1"
                alt="Financial image 2 "
                class="absolute w-[310px]"
              />
              <img
                :src="fscm_2"
                alt="Financial image 1"
                class="absolute right-0 translate-y-1/2 w-[310px]"
              />
            </div>
          </div>
        </div>
